                        ...
                        if ( empty (
                            ...
                            if ( isset ($_GET['token']) ) {
                                ...
                                if ( $_GET['token'] == "no" && isset ($_GET['except']) ) {
                                    ...
                                    $columnsExcept = [htmlspecialchars($_GET['except'])];
                                    
                                    if ( empty (
                                        $lab -> columnsData ($conexion,$tabla,iterar_post_2 ($columnsExcept))
                                        )
                                    ) {
                                    ...
                                    $lab -> postData ( $tabla , columns_values(iterar_post ($columnsExcept),iterar_post_2 ($columnsExcept)) , $conexion );
